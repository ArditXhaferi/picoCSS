<script>
    let items = {
    "a": "<b>a</b>spect-ratio: auto;",
    "a1": "aspect-ratio: 1 / 1;",
    "a9": "aspect-ratio: 16 / 9;",
    "sm": "max-width: 24rem;",
    "r": "border-radius: 0.25rem;",
    "s": "max-width: 640px;",
    "m": "max-width: 768px;",
    "l": "max-width: 1024px;",
    "x": "max-width: 1280px;",
    ...
    "bb": "break-before: auto;",
    "bbav": "break-before: avoid;",
    "bbal": "break-before: all;",
    ...
    "bc": "box-decoration-break: clone;",
    "bs": "box-decoration-break: slice;",
    "sb": "box-sizing: border-box;",
    "sc": "box-sizing: content-box;",
    "b": "display: block;",
    ...
    "i": "isolation: isolate;",
    "ia": "isolation: auto;",
    "oc": "object-fit: contain;",
    "oco": "object-fit: cover;",
    "of": "object-fit: fill;",
    "on": "object-fit: none;",
    "osd": "object-fit: scale-down;",
    "ob": "object-position: bottom;",
    "oc": "object-position: center;",
    "ol": "object-position: left;",
    "olb": "object-position: left bottom;",
    "olt": "object-position: left top;",
    "or": "object-position: right;",
    "orb": "object-position: right bottom;",
    "ort": "object-position: right top;",
    "ot": "object-position: top;",
    "oa": "overflow: auto;",
    "o": "overflow: hidden;",
    "oc": "overflow: clip;",
    "ov": "overflow: visible;",
    ...
    "ova": "overscroll-behavior: auto;",
    "ovc": "overscroll-behavior: contain;",
    "ovn": "overscroll-behavior: none;",
    "ovya": "overscroll-behavior-y: auto;",
    "ovyc": "overscroll-behavior-y: contain;",
    "ovyb": "overscroll-behavior-y: none;",
    "ovxa": "overscroll-behavior-x: auto;",
    "ovxc": "overscroll-behavior-x: contain;",
    "ovxn": "overscroll-behavior-x: none;",
    "s": "position: static;",
    "fi": "position: fixed;",
    "a": "position: absolute;",
    "r": "position: relative;",
...
function shortenKeys(obj) {
  ...
  for (const key in obj) {
    let shortenedKey = key;

    // Remove unwanted characters
    shortenedKey = shortenedKey.replace(/[^a-zA-Z0-9]/g, '');

    // Check if the shortened key already exists
    let count = 2;
    let uniqueKey = shortenedKey.substring(0, count);
    while (shortenedObj[uniqueKey] !== undefined && shortenedObj[uniqueKey] !== obj[key]) {
      count++;
      uniqueKey = shortenedKey.substring(0, count);
    }

    shortenedObj[uniqueKey] = obj[key];
  }
...
// const shortenedObj = shortenKeys(test);
...
<div class="box">
    ...
    <input type="text" bind:value={searchTerm} on:input={searchItems}>
    <div class="grid">
